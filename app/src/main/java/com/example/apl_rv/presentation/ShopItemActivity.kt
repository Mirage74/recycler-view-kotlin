...
//        binding = ViewBinding.setContentView(this, R.layout.activity_shop_item)
//        parseIntent()
//        viewModel = ViewModelProvider(this, ShopItemViewModelFactory(application))[ShopItemViewModel::class.java]
